...
#!/bin/bash
echo "Hello DevOps"
Why it matters: Ensures the script runs with Bash, not another shell.
...
Inline comment: Inline comments can be added after a command to explain it.
echo "Hello" # prints Hello

4. Variables

Variables store values.
Declare a variable: NAME="DevOps"

Use the variable: echo $NAME
